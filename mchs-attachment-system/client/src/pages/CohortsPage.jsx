          ...
          {cohorts.map((c) => (
            <div key={c.id} className="card p-5">
              ...
              <div className="space-y-1.5 text-sm text-navy-600 mb-4">
                <p>Year 1: <span className="font-semibold">{c.yearBreakdown['Year 1']} Students</span></p>
                <p>Year 2: <span className="font-semibold">{c.yearBreakdown['Year 2']} Students</span></p>
                <p>Year 3: <span className="font-semibold">{c.yearBreakdown['Year 3']} Students</span></p>
              </div>
